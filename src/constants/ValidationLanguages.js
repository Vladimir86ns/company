export const validationLanguages = {
	srb: {
		...
		email                : 'Email mora biti validna adresa.',
		// in                   : 'The selected :attribute must be :values.',
		// integer              : 'The :attribute must be an integer.',
		max                  : 'Polje :attribute ne sme imati vise od :max:type.',
		min                  : 'Polje :attribute ne sme imati manje od :min:type.',
