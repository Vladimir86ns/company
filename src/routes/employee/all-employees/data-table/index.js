...
import { 
    getEmployees,
    resetEmployee,
    deleteEmployee as deleteEmployeeFromApi
 } from '../../../../actions';
        ...
        return (
            <div className="user-management">
                ...
                <DeleteConfirmationDialog
                    ...
                    title={<IntlMessages id={`employee.delete.title`} />}
                    message={<IntlMessages id={`employee.delete.message`} />}
                ...
                <Modal isOpen={this.state.addNewUserModal} toggle={() => this.onUpdateEmployeeModalClose()}>
                    <ModalHeader toggle={() => this.onUpdateEmployeeModalClose()}>
                        <IntlMessages id={`general.employee.update_employee`} />
                    </ModalHeader>
                    <ModalBody>
                        {
                            editEmployee ?
